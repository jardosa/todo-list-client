...
const IndividualPost: React.FC<IndividualPostInterface> = ({
    ...
    const [removePost] = useRemovePostMutation({
        ...
        refetchQueries: [
            {
                query: PostsDocument,
                variables: { searchInput: { userId: post.userId, limit: 10 } },
            },
        ],
    })
            ...
            updatePost({
                variables: {
                    updatePostInput: {
                        _id: post._id,
                        status: PostStatus[
                            selectedStatus as keyof typeof PostStatus
                        ],
        ...
        >
                ...
                <div className="flex flex-col gap-2 ">
                    <div>
                        ...
                        <Link
                            ...
                            href={'/users/' + userData?.whoAmI?._id}
                        >
                            {fullName}
                        </Link>
                    </div>
            ...
            <div className="flex flex-col gap-2 ">
                ...
                <div>
                    <TextArea
                        ...
                        error={!!updateError}
                        value={description}
                        className="min-h-[50px] disabled:bg-white"
            ...
            {mode === 'write' && ownDocument && (
                <div className="flex flex-row flex-nowrap gap-1">
                    ...
                    <Button
                        type="submit"
                        disabled={!!updateError || !isFormValid}
