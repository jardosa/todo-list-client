...
const Register = () => {
    ...
    if (email && validateEmail(email) && password && firstName && lastName) {
        isFormValid = true
    }
    ...
    return (
        <div className="w-full h-screen grid place-items-center">
            <div className=" m-5 rounded-md outline outline-2 outline-gray-300  max-w-[400px] w-full h-max flex flex-col items-center">
                <div className="h-[100px] w-full bg-green-300 text-xl grid place-items-center">
                    Insert Logo Here
                </div>
                <form
                    onSubmit={onSubmit}
                    className="flex flex-col gap-5 w-full px-5 py-10 relative"
                >
